...
from layers.batch import create_masks
from layers.optim import CosineWithRestarts
...
class Newsela(TranslationDataset):
    ...
    def splits(cls, exts, fields, root='data',
               train='test', validation='valid', test='test', **kwargs):
...
model = Transformer(ntokens, emsize, nhid, nhead, nlayers, p=dropout, max_len=5000, device=device).to(device)
