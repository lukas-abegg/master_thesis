...
if __name__ == "__main__":
    project_name = "bart-pwkp-eval"  # newsela-transformer-bert-weights
    tracking_active = True
    base_file_path = "/glusterfs/dfs-gfs-dist/abeggluk/pwkp_bart/_1/evaluation/joint/pgloss/beam/_1"
