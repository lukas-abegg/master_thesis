...
class SequenceGenerator(object):
    def __init__(self, model, beam_size=1, minlen=1, maxlen=None,
                 ...
                 unk_penalty=0, pad_idx=0, unk_idx=0, eos=0, len_tgt_vocab=0):
        ...
        self.vocab_size = len_tgt_vocab
        self.beam_size = beam_size
        self.minlen = minlen
        max_decoder_len = int(1e5)
    ...
    def generate_batched_itr(self, data_itr, beam_size=None, maxlen_a=0.0, maxlen_b=None, cuda=False):
        ...
        for sample in data_itr:
            s = make_variable(sample, cuda=cuda)
            input = s['net_input']
            ...
            for i, id in enumerate(s['id'].data):
                ...
                ref = strip_pad(s['target'].data[i, :], self.pad)
