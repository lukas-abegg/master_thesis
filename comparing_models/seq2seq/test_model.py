...
class LSTMModel(nn.Module):
    def __init__(self, args, src_vocab_length, target_vocab_length, use_cuda=True):
        super(LSTMModel, self).__init__()
        self.args = args
        self.use_cuda = use_cuda
        self.src_dict = src_vocab_length
        self.dst_dict = target_vocab_length
...
class LSTMDecoder(nn.Module):
    ...
    def forward(self, prev_output_tokens, encoder_out, incremental_state=None):
        ...
        bsz = prev_output_tokens.size(1)
        seqlen = prev_output_tokens.size(0)
