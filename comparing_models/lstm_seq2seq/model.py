...
from comparing_models.lstm_seq2seq.beam_search import SequenceGenerator
from comparing_models.lstm_seq2seq.seq import batch_sequences
from comparing_models.lstm_seq2seq.state import State


class Seq2Seq(nn.Module):

    def __init__(self, encoder=None, decoder=None, bridge=None, unk=None):
    ...
    def _decode_step(self, input_list, state_list, args_dict={},
        ...
        if remove_unknown:
            ...
            logits[:, self.unk].fill_(-float('inf'))
        if apply_lsm:
