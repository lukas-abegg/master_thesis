...
def read_file(datapath):
    ...
    df_newsela = pd.read_csv(datapath, delimiter="\t", header=None, encoding="utf-8", names=["doc_id", "docv_input", "docv_output", "input", "output"])
...
if __name__ == "__main__":
    ...
    write_dataset_config_to_file(filtered_data, input_lang, output_lang, newsela_path, "newsela_" + bert_model, "newsela", bert_model, config)
