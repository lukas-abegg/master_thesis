...
def train(train_iter, val_iter, generator, discriminator, max_epochs, num_steps, target_vocab, checkpoints_path, use_gpu=False,
    ...
    for epoch_i in range(1, max_epochs + 1):
        ...
        generator_model_path_to_save = checkpoints_path + "joint_{0:.3f}.epoch_{1}.pt".format(g_logging_meters['valid_loss'].avg, epoch_i)
...
if __name__ == "__main__":
    ...
    checkpoints_path = os.path.join(checkpoint_base, 'checkpoints/joint/pgloss_sari/')
