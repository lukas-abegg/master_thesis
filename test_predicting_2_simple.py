...
if __name__ == "__main__":
    ...
    experiments_mws_wordpiece = [
        ...
        {"base_path": "/glusterfs/dfs-gfs-dist/abeggluk/mws_transformer/_2_3", "eval": "evaluation/joint/reward/beam",
         "model": "checkpoints/joint/reward/best_generator_g_model.pt", "n_layers": 4},
        {"base_path": "/glusterfs/dfs-gfs-dist/abeggluk/mws_transformer/_7", "eval": "evaluation/mle/beam",
         "model": "checkpoints/mle/best_model.pt", "n_layers": 4},
    ]
    ...
    experiments_pwkp_wordpiece = [
        ...
        #  "model": "checkpoints/mle/best_model.pt", "n_layers": 4},
        {"base_path": "/glusterfs/dfs-gfs-dist/abeggluk/pwkp_transformer/_4", "eval": "evaluation/joint/pgloss/beam/_1",
         "model": "checkpoints/joint/pgloss/best_generator_g_model.pt", "n_layers": 4},
        {"base_path": "/glusterfs/dfs-gfs-dist/abeggluk/pwkp_transformer/_4", "eval": "evaluation/joint/pgloss/beam/_3",
         "model": "checkpoints/joint/pgloss/joint_1.525.epoch_3.pt", "n_layers": 4},
    ]
