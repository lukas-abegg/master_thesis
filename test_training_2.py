...
if __name__ == "__main__":
    ...
    checkpoint_base = "/glusterfs/dfs-gfs-dist/abeggluk/mws_transformer/_0_1"
    ...
    model_path = os.path.join("/glusterfs/dfs-gfs-dist/abeggluk/mws_transformer", "_0/checkpoints/mle", model_path)
