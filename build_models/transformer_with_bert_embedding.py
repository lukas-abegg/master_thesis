...
from layers.transformer_with_gru import TransformerModel as Transformer
...
def build_model(hyperparameter_config, dataset_config, bert_model, bert_tokenizer):
    ...
    model = Transformer(vocab_size, ninp, nheads, nhidden, n_layers, dropout, embedding_layer, max_len)
